  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Text(
          "${weather.temperature.current.toInt()}°C", 
          style: const TextStyle(
            fontSize: 40,
            color: Colors.white,
            fontWeight: FontWeight.bold,
        ...
        Container(
          ...
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage("assets/cloduy.png"),
            ),
          ),
        ),
        const SizedBox(height: 30),
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        weatherInfoCard(
                            title: "Viento", value: "${weather.wind.speed}km/h"),
                      ],
                    ),
                    Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 5),
                        weatherInfoCard(
                            title: "Humedad", value: "${weather.humidity}%"),
                      ],
                    ),
                    Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        const SizedBox(height: 5),
                        weatherInfoCard(
                            title: "Presion", value: "${weather.pressure}hPa"),
                      ],
                    ),
                    Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        const SizedBox(height: 5),
                        weatherInfoCard(
                            title: "Nivel del mar", value: "${weather.seaLevel}m"),
                      ],
                    ),
                  ],
                )
